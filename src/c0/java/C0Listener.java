...
public interface C0Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link C0Parser#variableDefinition}.
	 * @param ctx the parse tree
	 */
	void enterVariableDefinition(C0Parser.VariableDefinitionContext ctx);
	/**
	 * Exit a parse tree produced by {@link C0Parser#variableDefinition}.
	 * @param ctx the parse tree
	 */
