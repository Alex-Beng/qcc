...
public interface C0Visitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitLogicalOrExpr(C0Parser.LogicalOrExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLogicalAndExpr(C0Parser.LogicalAndExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSuffixExpr(C0Parser.SuffixExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDecIntegerConst(C0Parser.DecIntegerConstContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCharConst(C0Parser.CharConstContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitStringConst(C0Parser.StringConstContext ctx);
}